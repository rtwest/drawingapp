...
var API_URL = 'https://service-poc.azure-mobile.net/';
var API_KEY = 'IfISqwqStqWVFuRgKbgJtedgtBjwrc24'; // Application Key (not Master Key)
...
angular.module('azure-mobile-service.module', [])
  .service('Azureservice', function Azureservice($q) {
      ...
      /* 
      NEED TO BE DECLARED GLOBALLY FOR USE BEYOND THIS NG MODULE.  DECLARED AT TOP OF CODE
      var API_URL = 'https://service-poc.azure-mobile.net/';
      var API_KEY = 'IfISqwqStqWVFuRgKbgJtedgtBjwrc24'; // Application Key (not Master Key)
      var MobileServiceClient = WindowsAzure.MobileServiceClient;
      var client = new MobileServiceClient(API_URL, API_KEY);
      */
      ...
      var getCachedUser = function () {
          if (localStorage.loggedInUser) {
              client.currentUser = JSON.parse(localStorage.loggedInUser);
          }
      };
      ...
      return {
          ...
          */
          ...
          login: function (oauthProvider) {
              ...
              var promise = client.login(oauthProvider).then(function () {
                  //cache login 
                  localStorage.loggedInUser = JSON.stringify(client.currentUser);
              });
          ...
          */
          ...
          isLoggedIn: function () {
              return isNotNullOrUndefined(client.currentUser) && isNotNullOrUndefined(localStorage.loggedInUser);
          },
